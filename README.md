...
## One Year Later...
A year after release, I was exploring UI possibilities in Unreal Engine, and Aberration Express became the perfect project to learn Common UI and MVVM, while also applying performance knowledge I had gathered since the release. All the feedback I had received during the jam pointed to a UI refactor. Since I had to redesign the terminal anyway, I decided to experiment with both plugins fully.

A year after the release, I was exploring UI possibilities in Unreal Engine, when I realised Aberration Express was the perfect project for me to learn Common UI, MVVM and UI performance and best practices in general. All the feedback I received during the jam pointed out to a UI refactor. Since I had to redesign the terminal's UI anyway, I decided to use this opportunity to experiment with both plugins.
